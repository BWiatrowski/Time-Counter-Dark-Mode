...
function labelLight() {
	$('.toggle-switch').attr('alt', 'Go to dark mode - save energy and sight')
	$('.toggle-switch').attr('title', 'Go to dark mode - save energy and sight')
}
function goLight() {
...
window.onload = function () {
	if (localStorage.darkmode == 'true') {
		...
		console.log(
			"User hasn't selected dark or light mode from a past session, dark mode has been served by default and OS-level changes will automatically reflect"
		)
		if ($('body').hasClass('dark')) {
			labelDark()
		} else {
